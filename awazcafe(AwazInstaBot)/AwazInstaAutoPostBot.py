...
i=0
bot = Bot() 
PhotoPath = "C:/Users/owais/OneDrive/Desktop/IG Server/2. AwazInstBots/awazcafe(AwazInstaBot)/images"  # Change Directory to Folder with Pics that you want to upload
IGUSER = "awazcafe" 
PASSWD = "24491awais"  
#PhotoHashtag
